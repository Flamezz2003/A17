...
// Auth information
global.pairNumber = "254758589539";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["254758589539", "254790091750"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["254758589539", "254790091750"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["254758589539"];
global.OwnerName = process.env.OWNER_NAME || "Flamezz";
